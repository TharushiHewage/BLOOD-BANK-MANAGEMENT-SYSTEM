...
Public Class Donation_eligibility_conditions
    ...
    Private Sub btnprintmain_Click(sender As Object, e As EventArgs) Handles btnprintmain.Click
        ' Capture the panel content as an image
        Dim panelImage As Bitmap = CapturePanel(Panel1_conditions)
    ...
    Private Sub btnmedical_Click_1(sender As Object, e As EventArgs) Handles btnmedical.Click
        Me.Hide() ' Show the DeclarationForm when the button is clicked
        For_medical_users.Show()
    End Sub

    Private Sub btndec_Click_1(sender As Object, e As EventArgs) Handles btndec.Click
        Me.Hide() ' Show the DeclarationForm when the button is clicked
        Eligible_form.Show()
    End Sub
