...
Public Class Certificate_generator

    ' Public property to hold the name value
    Public Property DonorName As String
    Public Property DonationDate As Date

    ' Method to set the label text with the donor name
    Public Sub SetDonorName(name As String)
        lblname.Text = name
    End Sub


    ' Method to set the label text with the donation date
    Public Sub SetDonationDate(dateValue As Date)
        lbldate.Text = dateValue.ToString("dd/MM/yyyy")
    End Sub
    ...
    Private Sub Certificate_generator_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ' Set initial UI values if needed
        lblname.Text = DonorName
        lbldate.Text = DonationDate.ToString("dd/MM/yyyy")
    End Sub

    Private Sub btnprint_Click(sender As Object, e As EventArgs) Handles btnprint.Click
        ' Capture the panel content as an image
        Dim panelImage As Bitmap = CapturePanel(panelcertificate)
    ...
    Private Sub btnsave_Click(sender As Object, e As EventArgs) Handles btnsave.Click
        ...
        ' Show the SaveFileDialog and save the image if the user clicks OK
        If SD.ShowDialog() = DialogResult.OK Then
            Try
                panelImage.Save(SD.FileName, Imaging.ImageFormat.Png)
